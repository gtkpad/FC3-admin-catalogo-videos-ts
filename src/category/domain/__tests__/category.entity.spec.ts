...
describe("Category Unit Tests", () => {
  ...
  describe("constructor", () => {
    it("should create a category given only name", () => {
    ...
    it("should create a category with name, description, created_at parameters and is_active false", () => {
    ...
    it("should create a category given only name and description parameters", () => {
      const category = new Category({
        name: "Movie",
        description: "Movie description",
      });
    ...
    describe("category_id field", () => {
      ...
      test.each(arrange)("category_id = %j", ({ category_id }) => {
        ...
        if (category_id instanceof Uuid)
          expect(category.category_id.equals(category_id)).toBeTruthy();
      });
    });
